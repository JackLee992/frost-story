...
async function loadRelease() {
  try {
    ...
    const asset = Array.isArray(release.assets)
      ...
      : null;
    const version = typeof release.tag_name === 'string' ? release.tag_name : 'v0.3.0';
    ...
    $('downloadMeta').textContent = 'v0.3.0 · ARM64';
    $('releaseState').textContent = 'Android v0.3.0 已可玩';
  }
}
...
async function loadContentVersion() {
  try {
    ...
    $('contentState').textContent = '六章 24 节点 · 四语内容完整性校验后于下次启动安全切换';
  } catch {
